...
function SendMessageIcon(props: SendMessageIconProps) {
  const { size, onClick } = props;
  return (
    <svg
      onClick={onClick}
      className={cc(styles.SendMessageIcon, size === "small" && styles.small)}
      viewBox="0 0 28 28"
      version="1.1"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g id="🔍-Product-Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="ic_fluent_send_28_filled" fill="#c7c4c4" fillRule="nonzero">
            <path
